...
export default function BoardsView({ navigate }: Props) {
      ...
      {view === "list" ? (
        <BoxPanel title="BOARDS" style="double" width={78}>
          ...
          <div className="prompt-line">
            ...
            <span className="fg-bright-cyan" style={{ cursor: "pointer" }} onClick={() => navigate("menu")}>[Q]</span>
        ...
        <BoxPanel title={`${selectedBoard ?? "BOARD"} — NO MESSAGES`} style="double" width={78}>
          ...
          <HRule width={78} />
          <div className="prompt-line">
            <span className="fg-bright-cyan" style={{ cursor: "pointer" }} onClick={() => setView("list")}>[Q]</span>
